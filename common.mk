...
ifeq ($(LINUX_COMPILER),_EQUATOR_)
   CFLAGS += -D_EQUATOR_ -D_GNU_SOURCE -os=linux-2.6
endif
...
ifeq ($(LINUX_COMPILER),_ARM_D6446_)
  LDFLAGS += --static
  CFLAGS += -D_DAVINCI_
endif
...
ifeq ($(LINUX_COMPILER),_POWERPC_)
CROSS = /opt/freescale-2010.09/bin/powerpc-linux-gnu-
endif
...
ifneq ($(strip $(SO_TARGET)),)
  ...
  $(SO_TARGET) : $(OBJS)
	$(LD) $(OBJS) -o $(SO_TARGET) $(LDFLAGS) $(CXXFLAGS)
...
ifneq ($(strip $(APP_TARGET)),)
  ...
  $(APP_TARGET): $(OBJS)
	$(CC) $(OBJS) -o $(APP_TARGET) $(LDFLAGS) $(CXXFLAGS)
